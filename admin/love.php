          ...
          <section class="panel">
            ...
            <div class="table-responsive">
              <table class="table table-striped b-t text-small">
                ...
                <?
                $arr_work = $db->getRows("SELECT * FROM `otzivi`");
                    ...
                    <tr>
                        <script>
                            function set_status<?=$work['id']?>() {
                                $.ajax({
                                    type: "POST",
                                    data: "id=<?=$work['id']?>&action=статус_отзыв",
                                    url: "app/App.php",
                                    dataType: "text",
                        ...
                        <td><a href="<?=$work['url']?>" target="_blank"><?=$work['name']?></a></td>
                        <td><?=$work['text']?></td>
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="app/App.php?action=удалитьотзыв&id=<?=$work['id']?>"><font color="red" >Удалить отзыв</font></a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
